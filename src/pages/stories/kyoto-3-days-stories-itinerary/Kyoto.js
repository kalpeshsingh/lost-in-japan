    ...
    <div className="page-container">
      ...
      <div className="page-container__right">
        ...
        <p>
          ...
          that's the same as other Imperial Palace.
        </p>
        <p>
        ...
        <p>
          ...
          I was shy but people were casually walking naked and I was trying to
          be calm and pretending that this is not new to me.
        </p>
        <p>
